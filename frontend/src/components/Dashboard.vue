...
const levels = [
  ...
  },
  {
    ...
    challenges: [
      ...
      { id: 'challenge_level_three_7', component: challenge_level_three_7, symbol: 'η', label: { ar: 'التحدي 7', en: 'Challenge 7' }, summary: { ar: 'اختبار المنطق السريع بالأرقام.', en: 'Fast-paced numeric logic test.' } },
      { id: 'challenge_level_three_8', component: challenge_level_three_8, symbol: 'ζ', label: { ar: 'التحدي 8', en: 'Challenge 8' }, summary: { ar: 'لغز أخير يجمع بين التفكير والسرعة.', en: 'A final puzzle mixing reasoning with speed.' } },
    ],
  },
]
